...
def add_dataset_args(parser, train=False, gen=False):
    ...
    group.add_argument('--debug', type=store_true,
    ...
    if train:
        ...
        group.add_argument('--da-strategy', default=None, type=str,
                           help='data augmentation strategy: switchout, prototype or None')
    if gen:
