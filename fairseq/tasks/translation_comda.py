...
from fairseq.data import (
    ...
    IndexedAlignmentDataset, ComdaTranslationDataset, MixedDictionary
)

from . import FairseqTask, register_task


@register_task('translation_comda')
class ComdaTranslationTask(FairseqTask):
    """
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        # load proto source, proto target datasets and alignment dataset
        if len(src_datasets) == 1:
