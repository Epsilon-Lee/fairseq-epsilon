...
alignments = []
with open(args.align, 'r') as f_align:
    for line in f_align:
...
with open(args.src, 'r') as f_src, open(args.tgt, 'r') as f_tgt:
...
saveto_tgt_corpus = []
with open(saveto_src_path, 'w') as f_src, open(saveto_tgt_path, 'w') as f_tgt:
...
with open(saveto_src_path, 'w') as f_proto_src:
